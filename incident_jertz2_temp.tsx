    ...
    <div className={styles.filterGroup}>
      ...
      <div className={styles.segmented}>
        {(["all", "dry", "wet"] as const).map((w) => {
          ...
          // (scoringWindow !== null) ΓÇö it has no meaning for the Descriptive
          ...
          return (
            <button
              ...
              disabled={disabled}
              title={disabled ? "No scored validation days in the current Range for this weather ΓÇö pick a wider Range" : undefined}
            >
