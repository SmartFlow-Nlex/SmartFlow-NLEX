throw new Error("ARCHIVED - do not run. Team repo scripts from July 2026 (Kia's descriptive branch); superseded by the current trainers. An older copy; the newest is in the generation folder. Kept only as a record; see smartflow_scripts/README.md.");
